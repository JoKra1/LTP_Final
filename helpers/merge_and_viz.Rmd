...
train_rus_emb <- sub_dat_non_eng_rus[1:floor(0.85 * nrow(sub_dat_non_eng_rus)),]
test_rus_emb <- sub_dat_non_eng_rus[(floor(0.85 * nrow(sub_dat_non_eng_rus)) + 1): nrow(sub_dat_non_eng_rus),]

train_ger_emb <- sub_dat_non_eng_ger[1:floor(0.85 * nrow(sub_dat_non_eng_ger)),]
test_ger_emb <- sub_dat_non_eng_ger[(floor(0.85 * nrow(sub_dat_non_eng_ger)) + 1): nrow(sub_dat_non_eng_ger),]

# Drop some English tweets to achieve better balance
train_eng_emb <- train_eng[1:630000,]
test_eng_emb <- test_eng[1:110000,]
